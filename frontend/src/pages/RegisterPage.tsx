...
function RegisterPage() {
    return (
        ...
        <h1 className="text-xl font-bold text-zinc-300">Register Page</h1>
        <p className="mt-1 text-sm text-zinc-400 text-center">
            ...
            <p className="mt-1 text-sm text-zinc-400">
                You can check the updates on my 
                <a
                ...
                >
                    <FaGithub size={15} className="ml-1.5 inline-flex items-center" />
                    <span>GitHub</span>
            ...
            <Link to="/login">
                ...
                >
                    ...
                    <span className="ml-1.5 hidden md:inline">Redirect to Login</span>
                </button>
            </Link>
        </div>
    )
